  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        demo: {
          DEFAULT: "hsl(var(--demo-bar))",
          foreground: "hsl(var(--demo-bar-foreground))",
        },
        gaming: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 15px -4px hsl(var(--primary) / 0.2)" },
          "50%": { boxShadow: "0 0 30px -4px hsl(var(--primary) / 0.4)" },
        },
        "shimmer": {
        ...
        "border-glow": {
          "0%, 100%": { borderColor: "hsl(var(--primary) / 0.15)" },
